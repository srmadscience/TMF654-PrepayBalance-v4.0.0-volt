...
/**
 * The ReserveBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity Skipped properties: id,href,status,requestedDate,confirmationDate,relatedParty
 */
@Schema(description = "The ReserveBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity Skipped properties: id,href,status,requestedDate,confirmationDate,relatedParty")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalanceCreate   {
  ...
  public ReserveBalanceCreate description(String description) {
  ...
  public ReserveBalanceCreate reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ReserveBalanceCreate amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ReserveBalanceCreate bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public ReserveBalanceCreate channel(ChannelRef channel) {
  ...
  public ReserveBalanceCreate logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public ReserveBalanceCreate addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public ReserveBalanceCreate partyAccount(PartyAccountRef partyAccount) {
  ...
  public ReserveBalanceCreate product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public ReserveBalanceCreate addProductItem(ProductRef productItem) {
  ...
  public ReserveBalanceCreate requestor(RelatedParty requestor) {
  ...
  public ReserveBalanceCreate usageType(UsageType usageType) {
  ...
  public ReserveBalanceCreate validFor(TimePeriod validFor) {
  ...
  public ReserveBalanceCreate _atBaseType(String _atBaseType) {
  ...
  public ReserveBalanceCreate _atSchemaLocation(String _atSchemaLocation) {
  ...
  public ReserveBalanceCreate _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalanceCreate reserveBalanceCreate = (ReserveBalanceCreate) o;
    return Objects.equals(this.description, reserveBalanceCreate.description) &&
        Objects.equals(this.reason, reserveBalanceCreate.reason) &&
        Objects.equals(this.amount, reserveBalanceCreate.amount) &&
        Objects.equals(this.bucket, reserveBalanceCreate.bucket) &&
        Objects.equals(this.channel, reserveBalanceCreate.channel) &&
        Objects.equals(this.logicalResource, reserveBalanceCreate.logicalResource) &&
        Objects.equals(this.partyAccount, reserveBalanceCreate.partyAccount) &&
        Objects.equals(this.product, reserveBalanceCreate.product) &&
        Objects.equals(this.requestor, reserveBalanceCreate.requestor) &&
        Objects.equals(this.usageType, reserveBalanceCreate.usageType) &&
        Objects.equals(this.validFor, reserveBalanceCreate.validFor) &&
        Objects.equals(this._atBaseType, reserveBalanceCreate._atBaseType) &&
        Objects.equals(this._atSchemaLocation, reserveBalanceCreate._atSchemaLocation) &&
        Objects.equals(this._atType, reserveBalanceCreate._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, reason, amount, bucket, channel, logicalResource, partyAccount, product, requestor, usageType, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalanceCreate {\n");
