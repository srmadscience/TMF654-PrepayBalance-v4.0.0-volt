...
import io.swagger.model.ReserveBalanceCreateEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalanceCreateEvent   {
  @JsonProperty("event")
  private ReserveBalanceCreateEventPayload event = null;
  ...
  public ReserveBalanceCreateEvent event(ReserveBalanceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public ReserveBalanceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(ReserveBalanceCreateEventPayload event) {
    this.event = event;
  }

  public ReserveBalanceCreateEvent eventId(String eventId) {
  ...
  public ReserveBalanceCreateEvent eventTime(Date eventTime) {
  ...
  public ReserveBalanceCreateEvent eventType(String eventType) {
  ...
  public ReserveBalanceCreateEvent correlationId(String correlationId) {
  ...
  public ReserveBalanceCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ReserveBalanceCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ReserveBalanceCreateEvent description(String description) {
  ...
  public ReserveBalanceCreateEvent priority(String priority) {
  ...
  public ReserveBalanceCreateEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalanceCreateEvent reserveBalanceCreateEvent = (ReserveBalanceCreateEvent) o;
    return Objects.equals(this.event, reserveBalanceCreateEvent.event) &&
        Objects.equals(this.eventId, reserveBalanceCreateEvent.eventId) &&
        Objects.equals(this.eventTime, reserveBalanceCreateEvent.eventTime) &&
        Objects.equals(this.eventType, reserveBalanceCreateEvent.eventType) &&
        Objects.equals(this.correlationId, reserveBalanceCreateEvent.correlationId) &&
        Objects.equals(this.domain, reserveBalanceCreateEvent.domain) &&
        Objects.equals(this.title, reserveBalanceCreateEvent.title) &&
        Objects.equals(this.description, reserveBalanceCreateEvent.description) &&
        Objects.equals(this.priority, reserveBalanceCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, reserveBalanceCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalanceCreateEvent {\n");
