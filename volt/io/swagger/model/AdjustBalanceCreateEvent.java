...
import io.swagger.model.AdjustBalanceCreateEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class AdjustBalanceCreateEvent   {
  @JsonProperty("event")
  private AdjustBalanceCreateEventPayload event = null;
  ...
  public AdjustBalanceCreateEvent event(AdjustBalanceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public AdjustBalanceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(AdjustBalanceCreateEventPayload event) {
    this.event = event;
  }

  public AdjustBalanceCreateEvent eventId(String eventId) {
  ...
  public AdjustBalanceCreateEvent eventTime(Date eventTime) {
  ...
  public AdjustBalanceCreateEvent eventType(String eventType) {
  ...
  public AdjustBalanceCreateEvent correlationId(String correlationId) {
  ...
  public AdjustBalanceCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AdjustBalanceCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AdjustBalanceCreateEvent description(String description) {
  ...
  public AdjustBalanceCreateEvent priority(String priority) {
  ...
  public AdjustBalanceCreateEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdjustBalanceCreateEvent adjustBalanceCreateEvent = (AdjustBalanceCreateEvent) o;
    return Objects.equals(this.event, adjustBalanceCreateEvent.event) &&
        Objects.equals(this.eventId, adjustBalanceCreateEvent.eventId) &&
        Objects.equals(this.eventTime, adjustBalanceCreateEvent.eventTime) &&
        Objects.equals(this.eventType, adjustBalanceCreateEvent.eventType) &&
        Objects.equals(this.correlationId, adjustBalanceCreateEvent.correlationId) &&
        Objects.equals(this.domain, adjustBalanceCreateEvent.domain) &&
        Objects.equals(this.title, adjustBalanceCreateEvent.title) &&
        Objects.equals(this.description, adjustBalanceCreateEvent.description) &&
        Objects.equals(this.priority, adjustBalanceCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, adjustBalanceCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdjustBalanceCreateEvent {\n");
