 ...
 */
@Schema(description = "PartyAccount reference. A party account is an arrangement that a party has with an enterprise that provides products to the party.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class PartyAccountRef   {
  @JsonProperty("id")
   ...
   **/
  @JsonProperty("id")
  @Schema(required = true, description = "Unique identifier of the party account")
  @NotNull
  public String getId() {
    return id;
  }
   ...
   **/
  @JsonProperty("href")
  @Schema(description = "Reference of the party account")
   ...
   **/
  @JsonProperty("name")
  @Schema(description = "Name of the party account")
  ...
  public PartyAccountRef _atBaseType(String _atBaseType) {
  ...
  public PartyAccountRef _atSchemaLocation(String _atSchemaLocation) {
  ...
  public PartyAccountRef _atType(String _atType) {
  ...
  public PartyAccountRef _atReferredType(String _atReferredType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, partyAccountRef.id) &&
        Objects.equals(this.href, partyAccountRef.href) &&
        Objects.equals(this.description, partyAccountRef.description) &&
        Objects.equals(this.name, partyAccountRef.name) &&
        Objects.equals(this.status, partyAccountRef.status) &&
        Objects.equals(this._atBaseType, partyAccountRef._atBaseType) &&
        Objects.equals(this._atSchemaLocation, partyAccountRef._atSchemaLocation) &&
        Objects.equals(this._atType, partyAccountRef._atType) &&
        Objects.equals(this._atReferredType, partyAccountRef._atReferredType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, name, status, _atBaseType, _atSchemaLocation, _atType, _atReferredType);
  }
