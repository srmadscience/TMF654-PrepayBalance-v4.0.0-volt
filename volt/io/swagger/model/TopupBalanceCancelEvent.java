...
import io.swagger.model.TopupBalanceCancelEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TopupBalanceCancelEvent   {
  @JsonProperty("event")
  private TopupBalanceCancelEventPayload event = null;
  ...
  public TopupBalanceCancelEvent event(TopupBalanceCancelEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public TopupBalanceCancelEventPayload getEvent() {
    return event;
  }

  public void setEvent(TopupBalanceCancelEventPayload event) {
    this.event = event;
  }

  public TopupBalanceCancelEvent eventId(String eventId) {
  ...
  public TopupBalanceCancelEvent eventTime(Date eventTime) {
  ...
  public TopupBalanceCancelEvent eventType(String eventType) {
  ...
  public TopupBalanceCancelEvent correlationId(String correlationId) {
  ...
  public TopupBalanceCancelEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopupBalanceCancelEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TopupBalanceCancelEvent description(String description) {
  ...
  public TopupBalanceCancelEvent priority(String priority) {
  ...
  public TopupBalanceCancelEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopupBalanceCancelEvent topupBalanceCancelEvent = (TopupBalanceCancelEvent) o;
    return Objects.equals(this.event, topupBalanceCancelEvent.event) &&
        Objects.equals(this.eventId, topupBalanceCancelEvent.eventId) &&
        Objects.equals(this.eventTime, topupBalanceCancelEvent.eventTime) &&
        Objects.equals(this.eventType, topupBalanceCancelEvent.eventType) &&
        Objects.equals(this.correlationId, topupBalanceCancelEvent.correlationId) &&
        Objects.equals(this.domain, topupBalanceCancelEvent.domain) &&
        Objects.equals(this.title, topupBalanceCancelEvent.title) &&
        Objects.equals(this.description, topupBalanceCancelEvent.description) &&
        Objects.equals(this.priority, topupBalanceCancelEvent.priority) &&
        Objects.equals(this.timeOcurred, topupBalanceCancelEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopupBalanceCancelEvent {\n");
