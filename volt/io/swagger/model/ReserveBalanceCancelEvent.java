...
import io.swagger.model.ReserveBalanceCancelEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalanceCancelEvent   {
  @JsonProperty("event")
  private ReserveBalanceCancelEventPayload event = null;
  ...
  public ReserveBalanceCancelEvent event(ReserveBalanceCancelEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public ReserveBalanceCancelEventPayload getEvent() {
    return event;
  }

  public void setEvent(ReserveBalanceCancelEventPayload event) {
    this.event = event;
  }

  public ReserveBalanceCancelEvent eventId(String eventId) {
  ...
  public ReserveBalanceCancelEvent eventTime(Date eventTime) {
  ...
  public ReserveBalanceCancelEvent eventType(String eventType) {
  ...
  public ReserveBalanceCancelEvent correlationId(String correlationId) {
  ...
  public ReserveBalanceCancelEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ReserveBalanceCancelEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ReserveBalanceCancelEvent description(String description) {
  ...
  public ReserveBalanceCancelEvent priority(String priority) {
  ...
  public ReserveBalanceCancelEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalanceCancelEvent reserveBalanceCancelEvent = (ReserveBalanceCancelEvent) o;
    return Objects.equals(this.event, reserveBalanceCancelEvent.event) &&
        Objects.equals(this.eventId, reserveBalanceCancelEvent.eventId) &&
        Objects.equals(this.eventTime, reserveBalanceCancelEvent.eventTime) &&
        Objects.equals(this.eventType, reserveBalanceCancelEvent.eventType) &&
        Objects.equals(this.correlationId, reserveBalanceCancelEvent.correlationId) &&
        Objects.equals(this.domain, reserveBalanceCancelEvent.domain) &&
        Objects.equals(this.title, reserveBalanceCancelEvent.title) &&
        Objects.equals(this.description, reserveBalanceCancelEvent.description) &&
        Objects.equals(this.priority, reserveBalanceCancelEvent.priority) &&
        Objects.equals(this.timeOcurred, reserveBalanceCancelEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalanceCancelEvent {\n");
