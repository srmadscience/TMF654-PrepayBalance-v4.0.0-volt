...
import io.swagger.model.TopupBalanceCreateEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TopupBalanceCreateEvent   {
  @JsonProperty("event")
  private TopupBalanceCreateEventPayload event = null;
  ...
  public TopupBalanceCreateEvent event(TopupBalanceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public TopupBalanceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(TopupBalanceCreateEventPayload event) {
    this.event = event;
  }

  public TopupBalanceCreateEvent eventId(String eventId) {
  ...
  public TopupBalanceCreateEvent eventTime(Date eventTime) {
  ...
  public TopupBalanceCreateEvent eventType(String eventType) {
  ...
  public TopupBalanceCreateEvent correlationId(String correlationId) {
  ...
  public TopupBalanceCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopupBalanceCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TopupBalanceCreateEvent description(String description) {
  ...
  public TopupBalanceCreateEvent priority(String priority) {
  ...
  public TopupBalanceCreateEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopupBalanceCreateEvent topupBalanceCreateEvent = (TopupBalanceCreateEvent) o;
    return Objects.equals(this.event, topupBalanceCreateEvent.event) &&
        Objects.equals(this.eventId, topupBalanceCreateEvent.eventId) &&
        Objects.equals(this.eventTime, topupBalanceCreateEvent.eventTime) &&
        Objects.equals(this.eventType, topupBalanceCreateEvent.eventType) &&
        Objects.equals(this.correlationId, topupBalanceCreateEvent.correlationId) &&
        Objects.equals(this.domain, topupBalanceCreateEvent.domain) &&
        Objects.equals(this.title, topupBalanceCreateEvent.title) &&
        Objects.equals(this.description, topupBalanceCreateEvent.description) &&
        Objects.equals(this.priority, topupBalanceCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, topupBalanceCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopupBalanceCreateEvent {\n");
