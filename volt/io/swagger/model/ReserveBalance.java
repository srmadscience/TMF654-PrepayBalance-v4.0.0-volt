 ...
 */
@Schema(description = "The ReserveBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalance   {
  @JsonProperty("id")
  ...
  public ReserveBalance id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ReserveBalance href(String href) {
    this.href = href;
    return this;
  }
  ...
  public ReserveBalance confirmationDate(Date confirmationDate) {
  ...
  public ReserveBalance description(String description) {
  ...
  public ReserveBalance reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ReserveBalance requestedDate(Date requestedDate) {
  ...
  public ReserveBalance amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ReserveBalance bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public ReserveBalance channel(ChannelRef channel) {
  ...
  public ReserveBalance logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public ReserveBalance addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public ReserveBalance partyAccount(PartyAccountRef partyAccount) {
  ...
  public ReserveBalance product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public ReserveBalance addProductItem(ProductRef productItem) {
  ...
  public ReserveBalance relatedParty(List<RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ReserveBalance addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public ReserveBalance requestor(RelatedParty requestor) {
  ...
  public ReserveBalance status(ActionStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public ReserveBalance usageType(UsageType usageType) {
  ...
  public ReserveBalance validFor(TimePeriod validFor) {
  ...
  public ReserveBalance _atBaseType(String _atBaseType) {
  ...
  public ReserveBalance _atSchemaLocation(String _atSchemaLocation) {
  ...
  public ReserveBalance _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalance reserveBalance = (ReserveBalance) o;
    return Objects.equals(this.id, reserveBalance.id) &&
        Objects.equals(this.href, reserveBalance.href) &&
        Objects.equals(this.confirmationDate, reserveBalance.confirmationDate) &&
        Objects.equals(this.description, reserveBalance.description) &&
        Objects.equals(this.reason, reserveBalance.reason) &&
        Objects.equals(this.requestedDate, reserveBalance.requestedDate) &&
        Objects.equals(this.amount, reserveBalance.amount) &&
        Objects.equals(this.bucket, reserveBalance.bucket) &&
        Objects.equals(this.channel, reserveBalance.channel) &&
        Objects.equals(this.logicalResource, reserveBalance.logicalResource) &&
        Objects.equals(this.partyAccount, reserveBalance.partyAccount) &&
        Objects.equals(this.product, reserveBalance.product) &&
        Objects.equals(this.relatedParty, reserveBalance.relatedParty) &&
        Objects.equals(this.requestor, reserveBalance.requestor) &&
        Objects.equals(this.status, reserveBalance.status) &&
        Objects.equals(this.usageType, reserveBalance.usageType) &&
        Objects.equals(this.validFor, reserveBalance.validFor) &&
        Objects.equals(this._atBaseType, reserveBalance._atBaseType) &&
        Objects.equals(this._atSchemaLocation, reserveBalance._atSchemaLocation) &&
        Objects.equals(this._atType, reserveBalance._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, confirmationDate, description, reason, requestedDate, amount, bucket, channel, logicalResource, partyAccount, product, relatedParty, requestor, status, usageType, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalance {\n");
