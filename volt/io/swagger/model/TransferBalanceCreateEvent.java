...
import io.swagger.model.TransferBalanceCreateEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TransferBalanceCreateEvent   {
  @JsonProperty("event")
  private TransferBalanceCreateEventPayload event = null;
  ...
  public TransferBalanceCreateEvent event(TransferBalanceCreateEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public TransferBalanceCreateEventPayload getEvent() {
    return event;
  }

  public void setEvent(TransferBalanceCreateEventPayload event) {
    this.event = event;
  }

  public TransferBalanceCreateEvent eventId(String eventId) {
  ...
  public TransferBalanceCreateEvent eventTime(Date eventTime) {
  ...
  public TransferBalanceCreateEvent eventType(String eventType) {
  ...
  public TransferBalanceCreateEvent correlationId(String correlationId) {
  ...
  public TransferBalanceCreateEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TransferBalanceCreateEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TransferBalanceCreateEvent description(String description) {
  ...
  public TransferBalanceCreateEvent priority(String priority) {
  ...
  public TransferBalanceCreateEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransferBalanceCreateEvent transferBalanceCreateEvent = (TransferBalanceCreateEvent) o;
    return Objects.equals(this.event, transferBalanceCreateEvent.event) &&
        Objects.equals(this.eventId, transferBalanceCreateEvent.eventId) &&
        Objects.equals(this.eventTime, transferBalanceCreateEvent.eventTime) &&
        Objects.equals(this.eventType, transferBalanceCreateEvent.eventType) &&
        Objects.equals(this.correlationId, transferBalanceCreateEvent.correlationId) &&
        Objects.equals(this.domain, transferBalanceCreateEvent.domain) &&
        Objects.equals(this.title, transferBalanceCreateEvent.title) &&
        Objects.equals(this.description, transferBalanceCreateEvent.description) &&
        Objects.equals(this.priority, transferBalanceCreateEvent.priority) &&
        Objects.equals(this.timeOcurred, transferBalanceCreateEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferBalanceCreateEvent {\n");
