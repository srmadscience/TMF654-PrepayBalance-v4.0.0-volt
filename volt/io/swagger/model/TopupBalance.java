 ...
 */
@Schema(description = "Represents a detailed description of a recharge operation requested over a bucket (defined by a specific product or reference to a product (i.e.: a commercial id such as an msisidn) and a service type)")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TopupBalance   {
  @JsonProperty("id")
  ...
  public TopupBalance id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TopupBalance href(String href) {
    this.href = href;
    return this;
  }
  ...
  public TopupBalance confirmationDate(Date confirmationDate) {
  ...
  public TopupBalance description(String description) {
  ...
  public TopupBalance isAutoTopup(Boolean isAutoTopup) {
  ...
  public TopupBalance numberOfPeriods(Integer numberOfPeriods) {
  ...
  public TopupBalance reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public TopupBalance requestedDate(Date requestedDate) {
  ...
  public TopupBalance voucher(String voucher) {
  ...
  public TopupBalance amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public TopupBalance balanceTopup(RelatedTopupBalance balanceTopup) {
  ...
  public TopupBalance bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public TopupBalance channel(ChannelRef channel) {
  ...
  public TopupBalance logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public TopupBalance addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public TopupBalance partyAccount(PartyAccountRef partyAccount) {
  ...
  public TopupBalance paymentMethod(PaymentMethodRef paymentMethod) {
  ...
  public TopupBalance product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public TopupBalance addProductItem(ProductRef productItem) {
  ...
  public TopupBalance recurringPeriod(RecurringPeriodType recurringPeriod) {
  ...
  public TopupBalance relatedParty(List<RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public TopupBalance addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public TopupBalance requestor(RelatedParty requestor) {
  ...
  public TopupBalance status(ActionStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public TopupBalance usageType(UsageType usageType) {
  ...
  public TopupBalance validFor(TimePeriod validFor) {
  ...
  public TopupBalance _atBaseType(String _atBaseType) {
  ...
  public TopupBalance _atSchemaLocation(String _atSchemaLocation) {
  ...
  public TopupBalance _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopupBalance topupBalance = (TopupBalance) o;
    return Objects.equals(this.id, topupBalance.id) &&
        Objects.equals(this.href, topupBalance.href) &&
        Objects.equals(this.confirmationDate, topupBalance.confirmationDate) &&
        Objects.equals(this.description, topupBalance.description) &&
        Objects.equals(this.isAutoTopup, topupBalance.isAutoTopup) &&
        Objects.equals(this.numberOfPeriods, topupBalance.numberOfPeriods) &&
        Objects.equals(this.reason, topupBalance.reason) &&
        Objects.equals(this.requestedDate, topupBalance.requestedDate) &&
        Objects.equals(this.voucher, topupBalance.voucher) &&
        Objects.equals(this.amount, topupBalance.amount) &&
        Objects.equals(this.balanceTopup, topupBalance.balanceTopup) &&
        Objects.equals(this.bucket, topupBalance.bucket) &&
        Objects.equals(this.channel, topupBalance.channel) &&
        Objects.equals(this.logicalResource, topupBalance.logicalResource) &&
        Objects.equals(this.partyAccount, topupBalance.partyAccount) &&
        Objects.equals(this.paymentMethod, topupBalance.paymentMethod) &&
        Objects.equals(this.product, topupBalance.product) &&
        Objects.equals(this.recurringPeriod, topupBalance.recurringPeriod) &&
        Objects.equals(this.relatedParty, topupBalance.relatedParty) &&
        Objects.equals(this.requestor, topupBalance.requestor) &&
        Objects.equals(this.status, topupBalance.status) &&
        Objects.equals(this.usageType, topupBalance.usageType) &&
        Objects.equals(this.validFor, topupBalance.validFor) &&
        Objects.equals(this._atBaseType, topupBalance._atBaseType) &&
        Objects.equals(this._atSchemaLocation, topupBalance._atSchemaLocation) &&
        Objects.equals(this._atType, topupBalance._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, confirmationDate, description, isAutoTopup, numberOfPeriods, reason, requestedDate, voucher, amount, balanceTopup, bucket, channel, logicalResource, partyAccount, paymentMethod, product, recurringPeriod, relatedParty, requestor, status, usageType, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
