...
import io.swagger.model.ReserveBalanceFailureEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalanceFailureEvent   {
  @JsonProperty("event")
  private ReserveBalanceFailureEventPayload event = null;
  ...
  public ReserveBalanceFailureEvent event(ReserveBalanceFailureEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public ReserveBalanceFailureEventPayload getEvent() {
    return event;
  }

  public void setEvent(ReserveBalanceFailureEventPayload event) {
    this.event = event;
  }

  public ReserveBalanceFailureEvent eventId(String eventId) {
  ...
  public ReserveBalanceFailureEvent eventTime(Date eventTime) {
  ...
  public ReserveBalanceFailureEvent eventType(String eventType) {
  ...
  public ReserveBalanceFailureEvent correlationId(String correlationId) {
  ...
  public ReserveBalanceFailureEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ReserveBalanceFailureEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ReserveBalanceFailureEvent description(String description) {
  ...
  public ReserveBalanceFailureEvent priority(String priority) {
  ...
  public ReserveBalanceFailureEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalanceFailureEvent reserveBalanceFailureEvent = (ReserveBalanceFailureEvent) o;
    return Objects.equals(this.event, reserveBalanceFailureEvent.event) &&
        Objects.equals(this.eventId, reserveBalanceFailureEvent.eventId) &&
        Objects.equals(this.eventTime, reserveBalanceFailureEvent.eventTime) &&
        Objects.equals(this.eventType, reserveBalanceFailureEvent.eventType) &&
        Objects.equals(this.correlationId, reserveBalanceFailureEvent.correlationId) &&
        Objects.equals(this.domain, reserveBalanceFailureEvent.domain) &&
        Objects.equals(this.title, reserveBalanceFailureEvent.title) &&
        Objects.equals(this.description, reserveBalanceFailureEvent.description) &&
        Objects.equals(this.priority, reserveBalanceFailureEvent.priority) &&
        Objects.equals(this.timeOcurred, reserveBalanceFailureEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalanceFailureEvent {\n");
