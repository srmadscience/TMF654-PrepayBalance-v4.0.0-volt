...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TransferBalanceFailureEventPayload   {
  @JsonProperty("transferBalance")
  private TransferBalance transferBalance = null;

  public TransferBalanceFailureEventPayload transferBalance(TransferBalance transferBalance) {
  ...
  @Schema(description = "")
  @Valid
  public TransferBalance getTransferBalance() {
    return transferBalance;
  }

  public void setTransferBalance(TransferBalance transferBalance) {
    this.transferBalance = transferBalance;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransferBalanceFailureEventPayload transferBalanceFailureEventPayload = (TransferBalanceFailureEventPayload) o;
    return Objects.equals(this.transferBalance, transferBalanceFailureEventPayload.transferBalance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transferBalance);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferBalanceFailureEventPayload {\n");
