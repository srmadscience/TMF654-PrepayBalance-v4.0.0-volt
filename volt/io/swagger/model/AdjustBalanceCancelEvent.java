...
import io.swagger.model.AdjustBalanceCancelEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class AdjustBalanceCancelEvent   {
  @JsonProperty("event")
  private AdjustBalanceCancelEventPayload event = null;
  ...
  public AdjustBalanceCancelEvent event(AdjustBalanceCancelEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public AdjustBalanceCancelEventPayload getEvent() {
    return event;
  }

  public void setEvent(AdjustBalanceCancelEventPayload event) {
    this.event = event;
  }

  public AdjustBalanceCancelEvent eventId(String eventId) {
  ...
  public AdjustBalanceCancelEvent eventTime(Date eventTime) {
  ...
  public AdjustBalanceCancelEvent eventType(String eventType) {
  ...
  public AdjustBalanceCancelEvent correlationId(String correlationId) {
  ...
  public AdjustBalanceCancelEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public AdjustBalanceCancelEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AdjustBalanceCancelEvent description(String description) {
  ...
  public AdjustBalanceCancelEvent priority(String priority) {
  ...
  public AdjustBalanceCancelEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdjustBalanceCancelEvent adjustBalanceCancelEvent = (AdjustBalanceCancelEvent) o;
    return Objects.equals(this.event, adjustBalanceCancelEvent.event) &&
        Objects.equals(this.eventId, adjustBalanceCancelEvent.eventId) &&
        Objects.equals(this.eventTime, adjustBalanceCancelEvent.eventTime) &&
        Objects.equals(this.eventType, adjustBalanceCancelEvent.eventType) &&
        Objects.equals(this.correlationId, adjustBalanceCancelEvent.correlationId) &&
        Objects.equals(this.domain, adjustBalanceCancelEvent.domain) &&
        Objects.equals(this.title, adjustBalanceCancelEvent.title) &&
        Objects.equals(this.description, adjustBalanceCancelEvent.description) &&
        Objects.equals(this.priority, adjustBalanceCancelEvent.priority) &&
        Objects.equals(this.timeOcurred, adjustBalanceCancelEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class AdjustBalanceCancelEvent {\n");
