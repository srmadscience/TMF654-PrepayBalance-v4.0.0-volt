...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TopupBalanceFailureEventPayload   {
  @JsonProperty("topupBalance")
  private TopupBalance topupBalance = null;

  public TopupBalanceFailureEventPayload topupBalance(TopupBalance topupBalance) {
  ...
  @Schema(description = "")
  @Valid
  public TopupBalance getTopupBalance() {
    return topupBalance;
  }

  public void setTopupBalance(TopupBalance topupBalance) {
    this.topupBalance = topupBalance;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopupBalanceFailureEventPayload topupBalanceFailureEventPayload = (TopupBalanceFailureEventPayload) o;
    return Objects.equals(this.topupBalance, topupBalanceFailureEventPayload.topupBalance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(topupBalance);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopupBalanceFailureEventPayload {\n");
    
    sb.append("    topupBalance: ").append(toIndentedString(topupBalance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
