 ...
 */
@Schema(description = "reference to the LogicalResource eg MSISDN")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class LogicalResourceRef   {
  @JsonProperty("id")
  ...
  public LogicalResourceRef id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LogicalResourceRef href(String href) {
    this.href = href;
    return this;
  }
  ...
  public LogicalResourceRef name(String name) {
    this.name = name;
    return this;
  }
  ...
  public LogicalResourceRef _atBaseType(String _atBaseType) {
  ...
  public LogicalResourceRef _atSchemaLocation(String _atSchemaLocation) {
  ...
  public LogicalResourceRef _atType(String _atType) {
  ...
  public LogicalResourceRef _atReferredType(String _atReferredType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LogicalResourceRef logicalResourceRef = (LogicalResourceRef) o;
    return Objects.equals(this.id, logicalResourceRef.id) &&
        Objects.equals(this.href, logicalResourceRef.href) &&
        Objects.equals(this.name, logicalResourceRef.name) &&
        Objects.equals(this._atBaseType, logicalResourceRef._atBaseType) &&
        Objects.equals(this._atSchemaLocation, logicalResourceRef._atSchemaLocation) &&
        Objects.equals(this._atType, logicalResourceRef._atType) &&
        Objects.equals(this._atReferredType, logicalResourceRef._atReferredType);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogicalResourceRef {\n");
