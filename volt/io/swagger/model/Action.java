 ...
 */
@Schema(description = "an abstract resource. example extensions are BalanceTopup, BalanceDeduct")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class Action   {
  @JsonProperty("id")
  ...
  public Action href(String href) {
    this.href = href;
    return this;
  }
  ...
  public Action confirmationDate(Date confirmationDate) {
  ...
  public Action reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public Action requestedDate(Date requestedDate) {
  ...
  public Action amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public Action bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public Action channel(ChannelRef channel) {
  ...
  public Action logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public Action addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public Action partyAccount(PartyAccountRef partyAccount) {
  ...
  public Action product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public Action addProductItem(ProductRef productItem) {
  ...
  public Action relatedParty(List<RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public Action addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public Action requestor(RelatedParty requestor) {
  ...
  public Action status(ActionStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public Action usageType(UsageType usageType) {
  ...
  public Action validFor(TimePeriod validFor) {
  ...
  public Action _atBaseType(String _atBaseType) {
  ...
  public Action _atSchemaLocation(String _atSchemaLocation) {
  ...
  public Action _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, action.id) &&
        Objects.equals(this.href, action.href) &&
        Objects.equals(this.confirmationDate, action.confirmationDate) &&
        Objects.equals(this.description, action.description) &&
        Objects.equals(this.reason, action.reason) &&
        Objects.equals(this.requestedDate, action.requestedDate) &&
        Objects.equals(this.amount, action.amount) &&
        Objects.equals(this.bucket, action.bucket) &&
        Objects.equals(this.channel, action.channel) &&
        Objects.equals(this.logicalResource, action.logicalResource) &&
        Objects.equals(this.partyAccount, action.partyAccount) &&
        Objects.equals(this.product, action.product) &&
        Objects.equals(this.relatedParty, action.relatedParty) &&
        Objects.equals(this.requestor, action.requestor) &&
        Objects.equals(this.status, action.status) &&
        Objects.equals(this.usageType, action.usageType) &&
        Objects.equals(this.validFor, action.validFor) &&
        Objects.equals(this._atBaseType, action._atBaseType) &&
        Objects.equals(this._atSchemaLocation, action._atSchemaLocation) &&
        Objects.equals(this._atType, action._atType);
  }
