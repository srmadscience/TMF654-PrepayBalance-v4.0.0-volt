...
import io.swagger.model.TopupBalanceFailureEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TopupBalanceFailureEvent   {
  @JsonProperty("event")
  private TopupBalanceFailureEventPayload event = null;
  ...
  public TopupBalanceFailureEvent event(TopupBalanceFailureEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public TopupBalanceFailureEventPayload getEvent() {
    return event;
  }

  public void setEvent(TopupBalanceFailureEventPayload event) {
    this.event = event;
  }

  public TopupBalanceFailureEvent eventId(String eventId) {
  ...
  public TopupBalanceFailureEvent eventTime(Date eventTime) {
  ...
  public TopupBalanceFailureEvent eventType(String eventType) {
  ...
  public TopupBalanceFailureEvent correlationId(String correlationId) {
  ...
  public TopupBalanceFailureEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TopupBalanceFailureEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TopupBalanceFailureEvent description(String description) {
  ...
  public TopupBalanceFailureEvent priority(String priority) {
  ...
  public TopupBalanceFailureEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopupBalanceFailureEvent topupBalanceFailureEvent = (TopupBalanceFailureEvent) o;
    return Objects.equals(this.event, topupBalanceFailureEvent.event) &&
        Objects.equals(this.eventId, topupBalanceFailureEvent.eventId) &&
        Objects.equals(this.eventTime, topupBalanceFailureEvent.eventTime) &&
        Objects.equals(this.eventType, topupBalanceFailureEvent.eventType) &&
        Objects.equals(this.correlationId, topupBalanceFailureEvent.correlationId) &&
        Objects.equals(this.domain, topupBalanceFailureEvent.domain) &&
        Objects.equals(this.title, topupBalanceFailureEvent.title) &&
        Objects.equals(this.description, topupBalanceFailureEvent.description) &&
        Objects.equals(this.priority, topupBalanceFailureEvent.priority) &&
        Objects.equals(this.timeOcurred, topupBalanceFailureEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopupBalanceFailureEvent {\n");
