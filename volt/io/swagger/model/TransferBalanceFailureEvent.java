...
import io.swagger.model.TransferBalanceFailureEventPayload;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class TransferBalanceFailureEvent   {
  @JsonProperty("event")
  private TransferBalanceFailureEventPayload event = null;
  ...
  public TransferBalanceFailureEvent event(TransferBalanceFailureEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
  @Valid
  public TransferBalanceFailureEventPayload getEvent() {
    return event;
  }

  public void setEvent(TransferBalanceFailureEventPayload event) {
    this.event = event;
  }

  public TransferBalanceFailureEvent eventId(String eventId) {
  ...
  public TransferBalanceFailureEvent eventTime(Date eventTime) {
  ...
  public TransferBalanceFailureEvent eventType(String eventType) {
  ...
  public TransferBalanceFailureEvent correlationId(String correlationId) {
  ...
  public TransferBalanceFailureEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public TransferBalanceFailureEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TransferBalanceFailureEvent description(String description) {
  ...
  public TransferBalanceFailureEvent priority(String priority) {
  ...
  public TransferBalanceFailureEvent timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TransferBalanceFailureEvent transferBalanceFailureEvent = (TransferBalanceFailureEvent) o;
    return Objects.equals(this.event, transferBalanceFailureEvent.event) &&
        Objects.equals(this.eventId, transferBalanceFailureEvent.eventId) &&
        Objects.equals(this.eventTime, transferBalanceFailureEvent.eventTime) &&
        Objects.equals(this.eventType, transferBalanceFailureEvent.eventType) &&
        Objects.equals(this.correlationId, transferBalanceFailureEvent.correlationId) &&
        Objects.equals(this.domain, transferBalanceFailureEvent.domain) &&
        Objects.equals(this.title, transferBalanceFailureEvent.title) &&
        Objects.equals(this.description, transferBalanceFailureEvent.description) &&
        Objects.equals(this.priority, transferBalanceFailureEvent.priority) &&
        Objects.equals(this.timeOcurred, transferBalanceFailureEvent.timeOcurred);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferBalanceFailureEvent {\n");
