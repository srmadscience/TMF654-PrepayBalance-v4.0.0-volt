...
/**
 * The ReserveBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity Skipped properties: id,href
 */
@Schema(description = "The ReserveBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity Skipped properties: id,href")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class ReserveBalanceUpdate   {
  ...
  public ReserveBalanceUpdate confirmationDate(Date confirmationDate) {
  ...
  public ReserveBalanceUpdate description(String description) {
  ...
  public ReserveBalanceUpdate reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public ReserveBalanceUpdate requestedDate(Date requestedDate) {
  ...
  public ReserveBalanceUpdate amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public ReserveBalanceUpdate bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public ReserveBalanceUpdate channel(ChannelRef channel) {
  ...
  public ReserveBalanceUpdate logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public ReserveBalanceUpdate addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public ReserveBalanceUpdate partyAccount(PartyAccountRef partyAccount) {
  ...
  public ReserveBalanceUpdate product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public ReserveBalanceUpdate addProductItem(ProductRef productItem) {
  ...
  public ReserveBalanceUpdate relatedParty(List<RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public ReserveBalanceUpdate addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public ReserveBalanceUpdate requestor(RelatedParty requestor) {
  ...
  public ReserveBalanceUpdate status(ActionStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public ReserveBalanceUpdate usageType(UsageType usageType) {
  ...
  public ReserveBalanceUpdate validFor(TimePeriod validFor) {
  ...
  public ReserveBalanceUpdate _atBaseType(String _atBaseType) {
  ...
  public ReserveBalanceUpdate _atSchemaLocation(String _atSchemaLocation) {
  ...
  public ReserveBalanceUpdate _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReserveBalanceUpdate reserveBalanceUpdate = (ReserveBalanceUpdate) o;
    return Objects.equals(this.confirmationDate, reserveBalanceUpdate.confirmationDate) &&
        Objects.equals(this.description, reserveBalanceUpdate.description) &&
        Objects.equals(this.reason, reserveBalanceUpdate.reason) &&
        Objects.equals(this.requestedDate, reserveBalanceUpdate.requestedDate) &&
        Objects.equals(this.amount, reserveBalanceUpdate.amount) &&
        Objects.equals(this.bucket, reserveBalanceUpdate.bucket) &&
        Objects.equals(this.channel, reserveBalanceUpdate.channel) &&
        Objects.equals(this.logicalResource, reserveBalanceUpdate.logicalResource) &&
        Objects.equals(this.partyAccount, reserveBalanceUpdate.partyAccount) &&
        Objects.equals(this.product, reserveBalanceUpdate.product) &&
        Objects.equals(this.relatedParty, reserveBalanceUpdate.relatedParty) &&
        Objects.equals(this.requestor, reserveBalanceUpdate.requestor) &&
        Objects.equals(this.status, reserveBalanceUpdate.status) &&
        Objects.equals(this.usageType, reserveBalanceUpdate.usageType) &&
        Objects.equals(this.validFor, reserveBalanceUpdate.validFor) &&
        Objects.equals(this._atBaseType, reserveBalanceUpdate._atBaseType) &&
        Objects.equals(this._atSchemaLocation, reserveBalanceUpdate._atSchemaLocation) &&
        Objects.equals(this._atType, reserveBalanceUpdate._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(confirmationDate, description, reason, requestedDate, amount, bucket, channel, logicalResource, partyAccount, product, relatedParty, requestor, status, usageType, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReserveBalanceUpdate {\n");
