 ...
 */
@Schema(description = "The AdjustBalance resource allows adjustments to be made to the original BalanceTopup eg increment the amount, alter the recharge periodicity")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2023-10-06T18:35:16.707674+01:00[Europe/Dublin]")public class AdjustBalance   {
  @JsonProperty("id")
  ...
  public AdjustBalance id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AdjustBalance href(String href) {
    this.href = href;
    return this;
  }
  ...
  public AdjustBalance confirmationDate(Date confirmationDate) {
  ...
  public AdjustBalance description(String description) {
  ...
  public AdjustBalance reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public AdjustBalance requestedDate(Date requestedDate) {
  ...
  public AdjustBalance adjustType(AdjustType adjustType) {
  ...
  public AdjustBalance amount(Quantity amount) {
    this.amount = amount;
    return this;
  }
  ...
  public AdjustBalance bucket(BucketRef bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public AdjustBalance channel(ChannelRef channel) {
  ...
  public AdjustBalance logicalResource(List<LogicalResourceRef> logicalResource) {
    this.logicalResource = logicalResource;
    return this;
  }

  public AdjustBalance addLogicalResourceItem(LogicalResourceRef logicalResourceItem) {
  ...
  public AdjustBalance partyAccount(PartyAccountRef partyAccount) {
  ...
  public AdjustBalance product(List<ProductRef> product) {
    this.product = product;
    return this;
  }

  public AdjustBalance addProductItem(ProductRef productItem) {
  ...
  public AdjustBalance relatedParty(List<RelatedParty> relatedParty) {
    this.relatedParty = relatedParty;
    return this;
  }

  public AdjustBalance addRelatedPartyItem(RelatedParty relatedPartyItem) {
  ...
  public AdjustBalance requestor(RelatedParty requestor) {
  ...
  public AdjustBalance status(ActionStatusType status) {
    this.status = status;
    return this;
  }
  ...
  public AdjustBalance usageType(UsageType usageType) {
  ...
  public AdjustBalance validFor(TimePeriod validFor) {
  ...
  public AdjustBalance _atBaseType(String _atBaseType) {
  ...
  public AdjustBalance _atSchemaLocation(String _atSchemaLocation) {
  ...
  public AdjustBalance _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AdjustBalance adjustBalance = (AdjustBalance) o;
    return Objects.equals(this.id, adjustBalance.id) &&
        Objects.equals(this.href, adjustBalance.href) &&
        Objects.equals(this.confirmationDate, adjustBalance.confirmationDate) &&
        Objects.equals(this.description, adjustBalance.description) &&
        Objects.equals(this.reason, adjustBalance.reason) &&
        Objects.equals(this.requestedDate, adjustBalance.requestedDate) &&
        Objects.equals(this.adjustType, adjustBalance.adjustType) &&
        Objects.equals(this.amount, adjustBalance.amount) &&
        Objects.equals(this.bucket, adjustBalance.bucket) &&
        Objects.equals(this.channel, adjustBalance.channel) &&
        Objects.equals(this.logicalResource, adjustBalance.logicalResource) &&
        Objects.equals(this.partyAccount, adjustBalance.partyAccount) &&
        Objects.equals(this.product, adjustBalance.product) &&
        Objects.equals(this.relatedParty, adjustBalance.relatedParty) &&
        Objects.equals(this.requestor, adjustBalance.requestor) &&
        Objects.equals(this.status, adjustBalance.status) &&
        Objects.equals(this.usageType, adjustBalance.usageType) &&
        Objects.equals(this.validFor, adjustBalance.validFor) &&
        Objects.equals(this._atBaseType, adjustBalance._atBaseType) &&
        Objects.equals(this._atSchemaLocation, adjustBalance._atSchemaLocation) &&
        Objects.equals(this._atType, adjustBalance._atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, confirmationDate, description, reason, requestedDate, adjustType, amount, bucket, channel, logicalResource, partyAccount, product, relatedParty, requestor, status, usageType, validFor, _atBaseType, _atSchemaLocation, _atType);
  }
