...
public class ListenerApiServiceImpl_listenToTransferBalanceCreateEvent extends VoltProcedure {
    ...
    final Type transferBalanceCreateEvent_type = new TypeToken<io.swagger.model.TransferBalanceCreateEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TransferBalanceCreateEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TransferBalanceCreateEvent) fromJson(body,transferBalanceCreateEvent_type);
        } catch (Exception e) { 
