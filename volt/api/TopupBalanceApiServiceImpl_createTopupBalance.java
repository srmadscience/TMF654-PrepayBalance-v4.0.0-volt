...
public class TopupBalanceApiServiceImpl_createTopupBalance extends VoltProcedure {
    ...
    final Type topupBalanceCreate_type = new TypeToken<io.swagger.model.TopupBalanceCreate>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TopupBalanceCreate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TopupBalanceCreate) fromJson(body,topupBalanceCreate_type);
        } catch (Exception e) { 
