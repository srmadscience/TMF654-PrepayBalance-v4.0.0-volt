...
public class ListenerApiServiceImpl_listenToTopupBalanceCancelEvent extends VoltProcedure {
    ...
    final Type topupBalanceCancelEvent_type = new TypeToken<io.swagger.model.TopupBalanceCancelEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TopupBalanceCancelEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TopupBalanceCancelEvent) fromJson(body,topupBalanceCancelEvent_type);
        } catch (Exception e) { 
