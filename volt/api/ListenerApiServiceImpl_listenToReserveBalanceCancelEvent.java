...
public class ListenerApiServiceImpl_listenToReserveBalanceCancelEvent extends VoltProcedure {
    ...
    final Type reserveBalanceCancelEvent_type = new TypeToken<io.swagger.model.ReserveBalanceCancelEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.ReserveBalanceCancelEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.ReserveBalanceCancelEvent) fromJson(body,reserveBalanceCancelEvent_type);
        } catch (Exception e) { 
