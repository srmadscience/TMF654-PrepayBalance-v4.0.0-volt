...
public class ListenerApiServiceImpl_listenToReserveBalanceCreateEvent extends VoltProcedure {
    ...
    final Type reserveBalanceCreateEvent_type = new TypeToken<io.swagger.model.ReserveBalanceCreateEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.ReserveBalanceCreateEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.ReserveBalanceCreateEvent) fromJson(body,reserveBalanceCreateEvent_type);
        } catch (Exception e) { 
