...
public class ListenerApiServiceImpl_listenToReserveBalanceFailureEvent extends VoltProcedure {
    ...
    final Type reserveBalanceFailureEvent_type = new TypeToken<io.swagger.model.ReserveBalanceFailureEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.ReserveBalanceFailureEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.ReserveBalanceFailureEvent) fromJson(body,reserveBalanceFailureEvent_type);
        } catch (Exception e) { 
