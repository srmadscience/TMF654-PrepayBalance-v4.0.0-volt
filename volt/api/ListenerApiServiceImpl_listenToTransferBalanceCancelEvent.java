...
public class ListenerApiServiceImpl_listenToTransferBalanceCancelEvent extends VoltProcedure {
    ...
    final Type transferBalanceCancelEvent_type = new TypeToken<io.swagger.model.TransferBalanceCancelEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TransferBalanceCancelEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TransferBalanceCancelEvent) fromJson(body,transferBalanceCancelEvent_type);
        } catch (Exception e) { 
