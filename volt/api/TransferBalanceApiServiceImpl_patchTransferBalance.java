...
public class TransferBalanceApiServiceImpl_patchTransferBalance extends VoltProcedure {
    ...
    final Type transferBalanceUpdate_type = new TypeToken<io.swagger.model.TransferBalanceUpdate>(){}.getType();
    ...
    public VoltTable[] run(String body, java.lang.String id)
        {
        ...
        io.swagger.model.TransferBalanceUpdate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TransferBalanceUpdate) fromJson(body,transferBalanceUpdate_type);
        } catch (Exception e) { 
