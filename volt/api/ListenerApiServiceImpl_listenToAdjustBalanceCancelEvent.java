...
public class ListenerApiServiceImpl_listenToAdjustBalanceCancelEvent extends VoltProcedure {
    ...
    final Type adjustBalanceCancelEvent_type = new TypeToken<io.swagger.model.AdjustBalanceCancelEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.AdjustBalanceCancelEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.AdjustBalanceCancelEvent) fromJson(body,adjustBalanceCancelEvent_type);
        } catch (Exception e) { 
