...
public class ListenerApiServiceImpl_listenToAdjustBalanceCreateEvent extends VoltProcedure {
    ...
    final Type adjustBalanceCreateEvent_type = new TypeToken<io.swagger.model.AdjustBalanceCreateEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.AdjustBalanceCreateEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.AdjustBalanceCreateEvent) fromJson(body,adjustBalanceCreateEvent_type);
        } catch (Exception e) { 
