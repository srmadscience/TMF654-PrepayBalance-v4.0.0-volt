...
public class ListenerApiServiceImpl_listenToTopupBalanceFailureEvent extends VoltProcedure {
    ...
    final Type topupBalanceFailureEvent_type = new TypeToken<io.swagger.model.TopupBalanceFailureEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TopupBalanceFailureEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TopupBalanceFailureEvent) fromJson(body,topupBalanceFailureEvent_type);
        } catch (Exception e) { 
