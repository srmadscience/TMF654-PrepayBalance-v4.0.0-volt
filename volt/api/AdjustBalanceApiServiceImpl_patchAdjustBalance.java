...
public class AdjustBalanceApiServiceImpl_patchAdjustBalance extends VoltProcedure {
    ...
    final Type adjustBalanceUpdate_type = new TypeToken<io.swagger.model.AdjustBalanceUpdate>(){}.getType();
    ...
    public VoltTable[] run(String body, java.lang.String id)
        ...
        io.swagger.model.AdjustBalanceUpdate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.AdjustBalanceUpdate) fromJson(body,adjustBalanceUpdate_type);
        } catch (Exception e) { 
