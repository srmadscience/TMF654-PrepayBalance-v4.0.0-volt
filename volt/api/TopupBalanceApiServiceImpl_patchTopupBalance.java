...
public class TopupBalanceApiServiceImpl_patchTopupBalance extends VoltProcedure {
    ...
    final Type topupBalanceUpdate_type = new TypeToken<io.swagger.model.TopupBalanceUpdate>(){}.getType();
    ...
    public VoltTable[] run(String body, java.lang.String id)
        ...
        io.swagger.model.TopupBalanceUpdate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TopupBalanceUpdate) fromJson(body,topupBalanceUpdate_type);
        } catch (Exception e) { 
