...
public class ReserveBalanceApiServiceImpl_createReserveBalance extends VoltProcedure {
    ...
    final Type reserveBalanceCreate_type = new TypeToken<io.swagger.model.ReserveBalanceCreate>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.ReserveBalanceCreate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.ReserveBalanceCreate) fromJson(body,reserveBalanceCreate_type);
        } catch (Exception e) { 
