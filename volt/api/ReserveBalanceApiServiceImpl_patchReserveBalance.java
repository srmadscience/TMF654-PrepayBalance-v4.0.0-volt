...
public class ReserveBalanceApiServiceImpl_patchReserveBalance extends VoltProcedure {
    ...
    final Type reserveBalanceUpdate_type = new TypeToken<io.swagger.model.ReserveBalanceUpdate>(){}.getType();
    ...
    public VoltTable[] run(String body, java.lang.String id)
        ...
        io.swagger.model.ReserveBalanceUpdate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.ReserveBalanceUpdate) fromJson(body,reserveBalanceUpdate_type);
        } catch (Exception e) { 
