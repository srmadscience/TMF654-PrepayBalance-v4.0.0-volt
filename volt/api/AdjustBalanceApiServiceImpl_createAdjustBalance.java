...
public class AdjustBalanceApiServiceImpl_createAdjustBalance extends VoltProcedure {
    ...
    final Type adjustBalanceCreate_type = new TypeToken<io.swagger.model.AdjustBalanceCreate>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.AdjustBalanceCreate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.AdjustBalanceCreate) fromJson(body,adjustBalanceCreate_type);
        } catch (Exception e) { 
