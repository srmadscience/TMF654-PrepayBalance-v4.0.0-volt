...
public class ListenerApiServiceImpl_listenToTransferBalanceFailureEvent extends VoltProcedure {
    ...
    // Types for JSON parameters
    final Type transferBalanceFailureEvent_type = new TypeToken<io.swagger.model.TransferBalanceFailureEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        {
        ...
        // Instantiated objects for JSON parameters
        io.swagger.model.TransferBalanceFailureEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TransferBalanceFailureEvent) fromJson(body,transferBalanceFailureEvent_type);
        } catch (Exception e) { 
            return castObjectToVoltTableArray(body,RESPONSE_BAD_REQUEST,"Invalid JSON:"+e.getMessage());
        }
