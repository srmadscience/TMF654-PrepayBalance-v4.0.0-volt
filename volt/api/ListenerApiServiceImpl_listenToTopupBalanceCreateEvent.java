...
public class ListenerApiServiceImpl_listenToTopupBalanceCreateEvent extends VoltProcedure {
    ...
    final Type topupBalanceCreateEvent_type = new TypeToken<io.swagger.model.TopupBalanceCreateEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TopupBalanceCreateEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TopupBalanceCreateEvent) fromJson(body,topupBalanceCreateEvent_type);
        } catch (Exception e) { 
