...
public class HubApiServiceImpl_registerListener extends VoltProcedure {
    ...
    final Type eventSubscriptionInput_type = new TypeToken<io.swagger.model.EventSubscriptionInput>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.EventSubscriptionInput bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.EventSubscriptionInput) fromJson(body,eventSubscriptionInput_type);
        } catch (Exception e) { 
