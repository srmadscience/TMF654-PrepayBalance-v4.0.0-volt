...
public class TransferBalanceApiServiceImpl_createTransferBalance extends VoltProcedure {
    ...
    final Type transferBalanceCreate_type = new TypeToken<io.swagger.model.TransferBalanceCreate>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.TransferBalanceCreate bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.TransferBalanceCreate) fromJson(body,transferBalanceCreate_type);
        } catch (Exception e) { 
