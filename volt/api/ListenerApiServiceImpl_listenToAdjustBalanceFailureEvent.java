...
public class ListenerApiServiceImpl_listenToAdjustBalanceFailureEvent extends VoltProcedure {
    ...
    final Type adjustBalanceFailureEvent_type = new TypeToken<io.swagger.model.AdjustBalanceFailureEvent>(){}.getType();
    ...
    public VoltTable[] run(String body)
        ...
        io.swagger.model.AdjustBalanceFailureEvent bodyAsObject = null;
        try {
            bodyAsObject = (io.swagger.model.AdjustBalanceFailureEvent) fromJson(body,adjustBalanceFailureEvent_type);
        } catch (Exception e) { 
